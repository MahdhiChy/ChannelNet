...
def SRCNN_model():     # SRCNN 模型
    ...
    c1 = Conv2D(filters=64, kernel_size=(9,9), activation = 'relu', padding='same')(x)
    c2 = Conv2D(filters=32, kernel_size=(1,1), activation = 'relu', padding='same')(c1)
    c3 = Conv2D(filters=1, kernel_size=(5,5), padding='same')(c2)
...
def DNCNN_model ():
    ...
    inpt = Input(shape=(72,14,1)) # (72,14,1)
    # 1st layer, Conv+relu
